  ...
  return (
    <div>
      <div className="flex items-center gap-3 mb-6">
        <Link href="/gares" className="text-zinc-400 hover:text-zinc-600">
          <ArrowLeft className="w-5 h-5" />
        </Link>
        <div>
          <h1 className="text-2xl font-bold text-[#1a3a2a]">📍 {gare?.nom || 'Chargement...'}</h1>
          <p className="text-zinc-500 text-sm mt-0.5">Bilan périodique</p>
        </div>
      </div>
          ...
          <div className="bg-white border border-zinc-200 rounded-2xl overflow-hidden">
            <table className="w-full text-sm">
              <thead className="bg-zinc-50 border-b border-zinc-200">
                <tr>
                  {['Date','Véhicule','Chauffeur','Rec. Gare','Rec. Route','Net'].map(h => (
